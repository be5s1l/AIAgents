...
# Load the AI model
llm = OllamaLLM(model="mistral") # can be changed to deepseek-r1
...
def listen():
    try:
        ...
        print("⚠️ Microphone input is not available. Falling back to keyboard input.")
        return input("Please type your query: ").strip().lower()
    except Exception as err:
        print(f"⚠️ Audio input failed: {err}")
        return input("Please type your query: ").strip().lower()
    try:
...
# Function to process the AI Responses
